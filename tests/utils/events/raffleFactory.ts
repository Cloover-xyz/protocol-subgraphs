...
export function createNewRaffleEvent(raffle: RaffleConfig): NewRaffle {
  ...
  tupleArray.push(ethereum.Value.fromUnsignedBigInt(raffle.ticketSalesDuration));
  tupleArray.push(ethereum.Value.fromI32(raffle.maxTotalSupply));
  tupleArray.push(ethereum.Value.fromI32(raffle.maxTicketAllowedToPurchase));
